...
PORT = int(os.environ.get("PORT", 10000))  # البورت من متغير البيئة

# إنشاء كائن Client باستخدام StringSession
app = Client(session_name=StringSession(SESSION_STRING), api_id=API_ID, api_hash=API_HASH)
